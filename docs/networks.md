...
| `sapos` | SAPOS HEPS/EPS | per-Länder (central: `sapos-ntrip.de:2101`) | Per-state web forms at sapos.de | ~270 stations; VRS; most Länder free; BY €20/yr flat rate for non-agricultural use (free for agriculture; under $200/yr cutoff); RP confirmed free; **in pipeline** as 14 `sapos_*` casters including SN (`ntrip.sachsen.de:2101`); DE |
