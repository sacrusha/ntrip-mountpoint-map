...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-india/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **Survey of India CORS** — operator: Survey of India — coverage: India
  - access_url:  https://cors.surveyofindia.gov.in/cors-services.php  [reachable: unverified — HTTP 000 / DNS fail]
...
## Raw extract
### National RTK network in India

**Survey of India CORS** — Paid national service.
- Coverage/Registration: https://cors.surveyofindia.gov.in/cors-services.php

### Free international RTK correction services in India
