...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-argentina/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **RAMSAC** — operator: IGN (Instituto Geográfico Nacional) — coverage: Argentina
  - landing_url: https://www.ign.gob.ar/NuestrasActividades/Geodesia/RamsacNtrip/Mapa  [reachable: reachable]
  - access_url:  https://www.ign.gob.ar/NuestrasActividades/Geodesia/RamsacNtrip  [reachable: reachable]
  - notes: Free national service; registration required via website or email
...
## Raw extract
### National RTK network in Argentina

**RAMSAC** (Red Argentina de Monitoreo Satelital Continuo) — Free national service operated by IGN.
- Coverage map: https://www.ign.gob.ar/NuestrasActividades/Geodesia/RamsacNtrip/Mapa
- Registration: https://www.ign.gob.ar/NuestrasActividades/Geodesia/RamsacNtrip

### Free international RTK correction services in Argentina

**RTK2GO** — Free global community based correction network without quality of service. Pass-to-pass centimeter accuracy, but not good for calibrated surveying applications.
