...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-oman/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **OMANCORSNET** — operator: Omani national service — coverage: Oman
  - landing_url: https://www.omancorsnet.gov.om/  [reachable: reachable]
  - access_url:  https://www.omancorsnet.gov.om/SBC/Account/Register  [reachable: reachable]
...
## Raw extract
### National RTK network in Oman

**OMANCORSNET** — Free national service.
- Coverage map: https://www.omancorsnet.gov.om/
- Registration: https://www.omancorsnet.gov.om/SBC/Account/Register

### Free international RTK correction services in Oman
