...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-turkey/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **TUSAGA-AKTIF** — operator: Turkish national authority — coverage: Turkey
  - landing_url: https://www.tusaga-aktif.gov.tr/  [reachable: reachable]
  - access_url:  https://www.tusaga-aktif.gov.tr/  [reachable: reachable]
...
## Raw extract
### National RTK network in Turkey

**TUSAGA-AKTIF** — Paid national service. Registration required via website or email.
- Landing/Registration: https://www.tusaga-aktif.gov.tr/

### Free international RTK correction services in Turkey
