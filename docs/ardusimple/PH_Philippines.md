...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-phillipines/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **Philippine Active Geodetic Network (PAGeNet)** — operator: NAMRIA — coverage: Philippines
  - landing_url: https://pagenet.namria.gov.ph/AGN/Home.aspx  [reachable: reachable]
  - access_url:  https://pagenet.namria.gov.ph/sbc/Account  [reachable: reachable]
...
## Raw extract
### National RTK network in Philippines

**Philippine Active Geodetic Network (PAGeNet)** — Paid national service.
- Coverage map: https://pagenet.namria.gov.ph/AGN/Home.aspx
- Registration: https://pagenet.namria.gov.ph/sbc/Account

### Free international RTK correction services in Philippines
