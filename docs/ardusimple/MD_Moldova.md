...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-moldova/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **MOLDPOS** — operator: Moldova national — coverage: Moldova
  - landing_url: https://www.moldpos.md/SBC/Account/Index?returnUrl=%2FSBC  [reachable: not-found]
  - access_url:  https://www.moldpos.md/SBC/Account/Register  [reachable: not-found]
...
## Raw extract
### National RTK network in Moldova

**MOLDPOS** — Paid national service.
- Coverage map: https://www.moldpos.md/SBC/Account/Index?returnUrl=%2FSBC
- Registration: https://www.moldpos.md/SBC/Account/Register

### Free international RTK correction services in Moldova
