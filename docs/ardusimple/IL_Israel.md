...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-israel/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **Israel Mapping Center** — operator: Israel Mapping Center — coverage: Israel
  - landing_url: https://www.gov.il/he/departments/survey_of_israel/govil-landing-page  [reachable: auth-required]
  - access_url:  https://www.gov.il/he/departments/survey_of_israel/govil-landing-page  [reachable: auth-required]
  - notes: Paid national service; registration required
...
## Raw extract
### National RTK network in Israel

**Israel Mapping Center** — Paid national service. Registration required.
- Landing/Registration: https://www.gov.il/he/departments/survey_of_israel/govil-landing-page

### Free international RTK correction services in Israel
