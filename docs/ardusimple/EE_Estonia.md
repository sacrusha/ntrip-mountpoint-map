...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-estonia/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **ESTPOS** — operator: Maaamet (Estonian Land Board) — coverage: Estonia
  - landing_url: https://geoportaal.maaamet.ee/eng/spatial-data/estpos-national-gnss-satellite-data-center-p839.html  [reachable: reachable]
  - access_url:  https://geoportaal.maaamet.ee/eng/spatial-data/estpos-national-gnss-satellite-data-center-p839.html  [reachable: reachable]
  - notes: Paid national service; registration via website or email
...
## Raw extract
### National RTK network in Estonia

**ESTPOS** — Paid national service operated by Estonian Land Board (Maaamet).
- Registration: https://geoportaal.maaamet.ee/eng/spatial-data/estpos-national-gnss-satellite-data-center-p839.html

### Free international RTK correction services in Estonia
...
### Paid international correction services in Estonia
