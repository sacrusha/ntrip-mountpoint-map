...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-austria/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **APOS** — operator: Austrian positioning service authority — coverage: Austria
  - landing_url: https://www.bev.gv.at/en/Services/Products/Austrian-POsitioning-Service.html  [reachable: auth-required]
  - access_url:  https://www.bev.gv.at/en/Services/Products/Austrian-POsitioning-Service.html#apos-products  [reachable: auth-required]
...
## Raw extract
### National RTK network in Austria

**APOS** (Austrian Positioning Service) — Paid national service.
- Landing: https://www.bev.gv.at/en/Services/Products/Austrian-POsitioning-Service.html
- Signup: https://www.bev.gv.at/en/Services/Products/Austrian-POsitioning-Service.html#apos-products
- Coverage map: https://www.bev.gv.at/en/Services/Products/Austrian-POsitioning-Service.html#quality-07-1

### Free international RTK correction services in Austria
...
### Paid international correction services in Austria

**u-blox PointPerfect Flex** — Starting from $5.90/month for up to 100 hours. Free 30-day trial available.
