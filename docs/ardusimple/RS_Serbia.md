...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-serbia/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **AGROS** — operator: Serbian national service (Republic Geodetic Authority) — coverage: Serbia
  - landing_url: http://www.agros.rgz.gov.rs/  [reachable: unverified — HTTP 000 / connection failed]
  - access_url:  http://www.agros.rgz.gov.rs/  [reachable: unverified — HTTP 000 / connection failed]
...
## Raw extract
### National RTK network in Serbia

**AGROS** — Paid national service. Registration required via website or email.
- Landing/Registration: http://www.agros.rgz.gov.rs/

### Free international RTK correction services in Serbia
...
### Paid international correction services in Serbia
