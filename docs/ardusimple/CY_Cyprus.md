...
source: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-cyprus/
fetched: 2026-05-16
fetch_passes: 1

## Networks (as listed by ardusimple)
- **CYPOS** — operator: Cyprus national (Department of Lands and Surveys) — coverage: Cyprus
  - access_url:  https://portal.dls.moi.gov.cy/alles-ypiresies/diktyo-cypos/  [reachable: reachable]
...
**CYPOS** — Paid national service.
- Registration: https://portal.dls.moi.gov.cy/alles-ypiresies/diktyo-cypos/
