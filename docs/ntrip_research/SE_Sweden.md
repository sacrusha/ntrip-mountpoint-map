...
| **last_confirmed_alive** | `nrtk-swepos.lm.se:80` returned `SOURCETABLE 200 OK` on 2026-05-13 (TCP probe; 7 STR mountpoints listed: MSM_GNSS, MSM_GEC, MSM_GRE, RTCM3_GNSS, RTCM3_GPS, RTCM2_GPS, DGNSS) |
...
- **Volunteer supplement (verified 2026-05-13)**: `py scripts/stations_by_country.py SWE` → rtk2go 28 SE volunteer bases (mostly south of ~60°N; northernmost OVIK at 63.31°N, Solbacka 62.5°N); Centipede 1 SE node (VISBY, Gotland). Sparse relative to Sweden's large area; effectively nothing in Norrland above ~63°N.
