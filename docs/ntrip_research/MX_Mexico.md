...
| Punto Visado | Hi-Target Red CORS 1-month licence | Hi-Target-aligned national | not published per month | https://www.puntovisado.com/producto/licencia-red-cors-1-mes/ |
...
- **rtk2go**: 5 MEX-tagged stations as of 2026-05-12 — BASE2_SG_ST1 (Tampico area 22.27 N -97.85), HelgenTestStation (Querétaro area 20.59 N -100.35), RTK_BASE_IBERO (Puebla 19.03 N -98.24), ZEFE (Tijuana area 31.79 N -116.59), palmitasrtk (Sinaloa 25.11 N -107.94). Coverage is sparse; useful only within ~30 km of each base.
- **EarthScope (NOTA)**: 17 stations tagged MEX in EarthScope's NTRIP sourcetable (e.g. CN24/CN25/PALX/QUEX/TNMT etc.), free with EarthScope NULA seat for non-commercial; $1,000/seat/yr for commercial. NOTA Mexico stations cluster along the northern border and a research line in the south.
...
- Survey+ MX CORS México: https://en.surveyplusmx.com/corsmexico (observed 2026-05-12)
...
- Local data: `py scripts/stations_by_country.py MEX` — 5 rtk2go, 17 EarthScope MEX-tagged streams (2026-05-12)
