...
**Date researched:** 2026-05-17 (re-probed; sourcetable now lists 25 STR records — 22 physical stations vs 21 on 2026-05-13: SENCORS_KAFF / Kaffrine 14.10°N -15.55°E added)
...
| **tariff** | Not publicly disclosed. Subscription plan described as "3 mois (90 jours) — Forfaitaire — Illimitée" (90-day flat-rate, unlimited). Price in XOF/USD not visible without account login. Contact ANAT: contact@anat.sn / +221 33 832 15 06. Date observed: 2026-05-17. Source: https://geodesie.sn/SBC/Account/Index |
...
| **last_confirmed_alive** | 2026-05-17 — curl --http0.9 of `caster.geodesie.sn:2101` returned `SOURCETABLE 200 OK` (Server: GNSS Spider 7.11.1.109/1.0; Content-Length 2886); 25 STR records (3 network products + 22 physical stations). `https://geodesie.sn/` HTTP 200; previous status "Le réseau est opérationnel" (2026-05-04 12:02) unchanged. |
| **datum_epoch** | omitted -- no citable declaration (no datum/epoch statement on `geodesie.sn/` or `geodesie.sn/SBC/`) |
...
| May 17, 2026 | Re-probe: 25 mountpoints; +SENCORS_KAFF (Kaffrine, 14.10°N -15.55°E); now 22 physical stations |
...
- TCP probe of `caster.geodesie.sn:2101` 2026-05-17 → SOURCETABLE 200 OK, 25 STR records (3 network + 22 physical), Server: GNSS Spider 7.11.1.109/1.0
- Local data check 2026-05-17: `py scripts/stations_by_country.py SEN` → Centipede 2 SN nodes (GORA, NKHR — both in/near Dakar region) + IGS-IP DAKR (14.72°N -17.44°E, co-located with SENCORS_MBOU area), supplementing SENCORS.
