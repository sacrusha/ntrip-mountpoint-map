...
|---|---|---|---|---|---|---|---|---|
| Baden-Württemberg | BW | LGL BW | `www.sapos-bw-ntrip.de:2101` | Free (€150 one-time admin fee per credential) | VRS_3_2G_BW · VRS_3_3G_BW · VRS_3_4G_BW | yes | unclear | 2026-05-07 |
| Bayern | BY | LDBV | `www.sapos-by-ntrip.de:2101` | €20/yr/account (incl. HEPS + GPPS; flat rate since 01.06.2024; no per-use charges; excl. VAT) | VRS_3_2G_BY · VRS_3_3G_BY · VRS_3_4G_BY | yes | unclear | 2026-05-07 |
| Berlin | BE | SenStadt Berlin | `www.sapos-be-ntrip.de:2101` | Free | VRS_3_2G_BE · VRS_3_3G_BE · VRS_3_4G_BE | yes | unclear | 2026-05-07 |
| Brandenburg | BB | LGB (Potsdam) | `www.sapos-bb-ntrip.de:2101` | Free (since 2020) | VRS_3_2G_BB · VRS_3_3G_BB · VRS_3_4G_BB | yes | unclear | 2026-05-07 |
| Bremen | HB | LGLN (shared with NI) | `www.openservice-sapos.niedersachsen.de:2101` or `www.sapos-ni-ntrip.de:2101` | Free | VRS_3_2G_NI · VRS_3_3G_NI · VRS_3_4G_NI | yes | unclear | 2026-05-07 |
| Hamburg | HH | LGV Hamburg (SAPOS GeoNord) | `www.sapos.geonord.de:2101` | Free (Hamburg data permanently free; Open Data registration-free service via `sapos.geonord-od.de:2101` user=gast/pass=gast) | VRS_3_2G_HH-SH · VRS_3_4G_HH-SH | yes | unclear | 2026-05-07 |
| Hessen | HE | HVBG | `www.sapos-he-ntrip.de:2101` | Free (since 01.01.2019) | VRS_3_2G_HE · VRS_3_4G_HE · VRS_3_2G_HE_GK · VRS_3_4G_HE_GK | yes | unclear | 2026-05-07 |
| Mecklenburg-Vorpommern | MV | LAiV MV | `www.sapos-mv-ntrip.de:2101` | Free (since 01.01.2024); one-time €100 admin fee per end-user at registration | openrtk_mv · VRS_3_2G_MV · VRS_3_4G_MV · VRS_3_GE_MV | yes ("für Jedermann") | unclear | 2026-05-07 |
| Niedersachsen | NI | LGLN | `www.openservice-sapos.niedersachsen.de:2101` or `www.sapos-ni-ntrip.de:2101` | Free (permanently, since Oct 2019) | VRS_3_2G_NI · VRS_3_3G_NI · VRS_3_4G_NI | yes | unclear | 2026-05-07 |
| Nordrhein-Westfalen | NW | Geobasis NRW / BezReg Köln | `www.sapos-nw-ntrip.de:2101` | Free | VRS_3_2G_NW · VRS_3_3G_NW · VRS_3_4G_NW · FKP_3_2G_NW · MAC_3_2G_NW · EPS_NW-VRS | yes | unclear | 2026-05-07 |
| Rheinland-Pfalz | RP | LVermGeo RLP | `www.sapos-ntrip.rlp.de:2101` (IP 83.243.48.22) | Paid: HEPS €120/yr/credential · GPPS €120/yr/credential · EPS €70/yr/credential · R-HEPS (agri) €150/yr; one-time setup €100 (HEPS/GPPS, since 03.06.2024); VAT not stated | VRS_3_2G_RP · VRS_3_3G_RP · VRS_3_4G_RP · VRS_3_GE_RP · MAC_3_2G_RP · FKP_3_2G_RP | yes | unclear | 2026-05-07 |
| Saarland | SL | LVGL Saarbrücken | `www.sapos-sl-ntrip.de:2101` | Free (registration required) | LW_HEPS_SL (VRS 4G) | yes | unclear | 2026-05-07 |
| Sachsen | SN | GeoSN | `www.ntrip.sachsen.de:2101` | Free (since Open Data rollout 2019; costs "fully eliminated") | VRS_3_2G_SN · VRS_3_4G_SN · FKP_3_2G_SN · MAC_3_2G_SN | yes | unclear | 2026-05-07 |
| Sachsen-Anhalt | ST | LVermGeo ST | `www.sapos-lsa-ntrip.de:2101` (primary; backup `www2.sapos-lsa-ntrip.de:2101`); 4G: `4g.sapos-lsa-ntrip.de:2101` | Free (since 01.07.2023); credentials user=user / pass=user for testing | VRS_3_2G_ST · VRS_3_4G_ST (HEPS); VRS_3_1G_ST / VRS_2_1G_ST / FKP / PRS / MAC variants | yes | unclear | 2026-05-07 |
| Schleswig-Holstein | SH | LVermGeo SH (SAPOS GeoNord) | `www.sapos.geonord.de:2101` | SH HEPS: €0.10/min (min. €10/month when used); R-HEPS SH (agri): €150/device/yr; Open Data service (registration-free): `sapos.geonord-od.de:2101` user=gast/pass=gast | VRS_3_2G_HH-SH · VRS_3_4G_HH-SH; R-HEPS SH via `www.sapossh.de:2101` | yes | unclear | 2026-05-07 |
| Thüringen | TH | TLBG | `www.sapos-th-ntrip.de:2101` (IP 195.191.15.131) | Free (since 01.01.2017; "all data and positioning services free"; guest login: Gast/Gast) | VRS_3_2G_TH · VRS_3_4G_TH · VRS_3_2G_TH_PD · VRS_3_4G_TH_PD | yes | unclear | 2026-05-07 |
...
### HxGN SmartNet Germany (Hexagon / Leica Geosystems)
- **Operator:** Hexagon Geosystems (formerly Leica Geosystems SmartNet)
- **Coverage:** Nationwide Germany (integrates SAPOS infrastructure + proprietary stations); also covers CH, AT, and broader Europe
- **NTRIP host:** Not publicly listed; provided after contract signing
- **Tariff:** Not published; enterprise contracts; reported $USD 5,000+/yr for national-tier access (contact hexagon.com for German-market pricing)
- **hobbyist_eligibility:** unclear; primarily marketed to professional surveyors and construction
- **Portal:** https://hxgnsmartnet.com/
...
**hobbyist eligibility:** No Bundesland found to explicitly require a professional surveying licence or business registration. Registration forms exist but appear open to individuals. The term "Nutzer" (user) is used generically. No legal_residency_required requirement found in any public documentation, though one ArduSimple source noted access credentials for non-German residents may require advance payment. Marked as "unclear" for residency throughout.
