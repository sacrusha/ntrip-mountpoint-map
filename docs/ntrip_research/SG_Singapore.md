...
| **last_confirmed_alive** | 2026-05-13 (app.sla.gov.sg/sirent/Page/Services reachable, tier table & GST-inclusive note still present; Services page footer shows Copyright © 2026; FAQ last substantive update 2020-06-08; Trimble customer-story page still describes 2022 Alloy hardware refresh. NTRIP host 203.127.20.71:2101 not probed from this sandbox — sourcetable is gated to authenticated subscribers and is not exposed publicly) |
...
- **Volunteer alternatives (verified 2026-05-13)**: Zero rtk2go bases in SG; zero Centipede nodes. `py scripts/stations_by_radius.py 1.36 103.8 200` finds only `gogainet` (Malaysia, 195 km north — out of practical RTK range). The city-state has no free RTK fallback. Visiting hobbyists using Singapore mobile networks could in principle subscribe to short-range commercial services like u-blox PointPerfect (SSR via PPP-RTK, not classical NTRIP RTK), but no free single-frequency or RTK option exists.
