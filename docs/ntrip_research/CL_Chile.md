...
**Date researched:** 2026-05-17 (re-verify 2026-05-15; deep 2026-05-12; initial 2026-05-06)
...
| num_stations | **27** stations per GEOCOM 2021-00 processing note (15 also belong to SIRGAS); operator narrative names 11 cities Calama→Puerto Montt (~23°S–41°S). https://www.geocom.cl/blogs/news/red-gnss-geocom-2021-00 |
| vrs | ? — 27-station nationwide network with ~100 km median spacing is technically plausible for VRS, but no operator page (access_url, GEOCOM 2021-00 note, geocaster.geocom.cl) declares VRS / MAC / FKP / iMAX / NEAR. Public sourcetable advertises only `TEST_RTCM`; production mountpoint names are not visible to confirm or refute |
...
| datum_epoch | omitted — GEOCOM 2021-00 post anchors a 2021-01-01 solution to GPS week 2138 via SIRGAS solution SIR20P2138, but that's an internal processing reference, not an operator-published frame declaration for the live NTRIP feed. https://www.geocom.cl/blogs/news/red-gnss-geocom-2021-00 |
...
| hobbyist_eligibility | yes during pilot — Emlid Reach RX / RS2 / RS2+ hardware required; brand-locked, non-Emlid receivers (ZED-F9P, Septentrio, Trimble, etc.) excluded |
...
**IGM / SIRGAS-CHILE national NTRIP** — Instituto Geográfico Militar launched "Época de Referencia 2025.0" in 2025 with 28 new first-level CORS (180+ including seismological partners) and a redesigned sirgaschile.cl portal. The 2025 launch described NTRIP / VRS / web-PPP as planned. As of 2026-05-17: (a) sirgaschile.cl homepage no longer mentions NTRIP/real-time/RTK/caster/streaming; (b) portal still offers only RINEX download + paid coordinate certificates via Webpay; (c) no caster host:port published; (d) `ntrip.igm.cl` no longer resolves in DNS; (e) the legacy `/Mapa_RGN.php` URL returns 404 (the site is now under SIRGAS-CHILE 2026 branding). IGS Workshop 2026 Santiago (1–5 June 2026, USACH + IGM) is the next plausible launch window — not committed. Sources: https://www.sirgaschile.cl/ · https://www.sirgaschile.cl/descarga_observaciones.php · https://sirgas.ipgh.org/en/news/igs-workshop-2026-june-1-5-2026/

**Ministerio de Bienes Nacionales — RINEX-only portal (2025-03-25)**: MBN published RINEX 3.0 daily files from 18 CORS stations distributed nationwide plus IGM-certified coordinate sheets via a SharePoint direct link on the ministry's banner. Free, open to public; post-processing only, **no NTRIP / real-time stream**. Sources: https://www.bienesnacionales.cl/informacion-geodesica-de-las-estaciones-cors-se-encuentra-disponible-en-banner-de-acceso-directo/ · https://ide.bienes.cl/
...
- **Argentina — RAMSAC-NTRIP (IGN):** free with self-registration (no surveying licence; registration form requests username/email/profession/receiver only — see `AR_Argentina.md`). Geographic adjacency is mixed: along most of the Andes the border is mountainous and unpopulated within 50 km, **but** the Argentine Cuyo corridor (Mendoza / San Juan) is adjacent to Chilean Norte Chico — settled valleys lie ≤50 km apart in places (Los Andes CL ↔ Uspallata / Mendoza AR), so a Chilean user in Norte Chico can plausibly reach a RAMSAC physical station within single-base range. Prior characterisation of RAMSAC as "national accreditation required" was incorrect.
- **Peru — IGN-PE / REGGEN:** see `PE_Peru.md` for current access posture; Chile–Peru border (Arica region) is desert and lightly populated within 50 km.
...
- Ministerio de Bienes Nacionales CORS RINEX banner (2025-03-25): https://www.bienesnacionales.cl/informacion-geodesica-de-las-estaciones-cors-se-encuentra-disponible-en-banner-de-acceso-directo/ ; IDE portal https://ide.bienes.cl/
- SIRGAS-CHILE: https://www.sirgaschile.cl/ (HTTP 200; no NTRIP text remains on homepage; legacy `/Mapa_RGN.php` = 404, 2026-05-17)
...
- ArduSimple Chile NTRIP overview: https://www.ardusimple.com/rtk-correction-services-and-ntrip-casters-in-chile/ (re-confirmed 2026-05-17: "Chile lacks a nationwide real-time RTK service"; flags Chile GNSS CORS as post-processing/PPK only)
...
- curl probe `http://ntrip.geocom.cl:2101/` → `SOURCETABLE 200 OK` 2026-05-17 21:21 UTC (`Server: Pycaster Ntrip Version 1`, one mountpoint `TEST_RTCM` RTCM/CMRx — unchanged from 2026-05-15)
