...
**Date researched:** 2026-05-06 | XCD/USD: fixed peg 1 USD = 2.70 XCD
...
| **Tariff — noncommercial** | **Free (USD $0.00 / XCD $0.00)** — account + annual NULA acceptance required. Date observed: 2026-05-06. Source: https://www.earthscope.org/data/gnss-realtime/ |
| **Tariff — commercial** | **USD $1,000 / XCD $2,700 per seat per year** (no VAT — EarthScope is US 501(c)(3) nonprofit). Min 5 seats for direct billing. Date observed: 2026-05-06. Source: https://www.earthscope.org/news/new-gnss-offering-and-licensing-details-for-commercial-use/ |
