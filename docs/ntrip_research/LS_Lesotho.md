...
No national CORS programme or NTRIP project announcement found for Lesotho as of 2026-05-06. The Department of Lands, Surveys and Physical Planning (DLSPP), under the Ministry of Local Government, Chieftainship, Home Affairs and Police, is the national geodetic authority, but no public documentation of a CORS installation or real-time GNSS service has been located.
...
- **No entries on rtk2go or Centipede:** Zero LS mountpoints observed in either public sourcetable.
