...
- Existing rtk_inventory.md `icecors` entry: docs/rtk_inventory.md (33 stations, 70–100 km spacing, GNSMART, registration via icecors@natt.is — pipeline NMEA filter caveat documented)
