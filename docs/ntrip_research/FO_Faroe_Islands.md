...
| **last_confirmed_alive** | `us.fo/kort/geodesi`: 2026-05-17 (agency geodesy page HTTP 200) |
...
- No Faroe Islands entry on ntrip-list.com/europe, RTK2go, or other aggregators. Centipede sourcetable 2026-05-17 has zero FRO-coded entries.
...
- Centipede sourcetable probe of `crtk.net:2101` 2026-05-17 — 0 FRO-coded mountpoints
