...
| **last_confirmed_alive** | `ugrf.mlhud.go.ug:2101` returned SOURCETABLE 200 OK on 2026-05-13 (re-confirmed; Leica GNSS Spider 7.10.1.168; 44 mountpoints; 4046-byte sourcetable) |

## Sourcetable Observations (2026-05-13)
...
- curl probe of `ugrf.mlhud.go.ug:2101` (154.72.216.21:2101) — SOURCETABLE 200 OK on 2026-05-06 and 2026-05-13 (re-confirmed unchanged); Leica GNSS Spider 7.10.1.168; 44 mountpoints (6 network + 38 single-base)
